...
export default class SelectRange extends Module {
   ...
   * @param {Range} removed Removed range instance.
   */
   ...
   * @param {Column} column Reference column.
   * @param {Array<Row>} rows Row set to search.
   * @param {boolean} reverse Search in reverse order.
   * @param {boolean} emptyStart Whether the starting cell is empty.
   * @param {boolean} emptySide Whether the adjacent cell is empty.
   ...
   * @param {Row} row Reference row.
   * @param {Array<Column>} columns Column set to search.
   * @param {boolean} reverse Search in reverse order.
   * @param {boolean} emptyStart Whether the starting cell is empty.
   * @param {boolean} emptySide Whether the adjacent cell is empty.
   ...
   * @param {boolean} emptyStart Whether the starting cell is empty.
   * @param {boolean} emptySide Whether the adjacent cell in the search direction is empty.
   * @param {Array<*>} items Items to search through.
   * @param {Function} valueResolver Extracts the comparable value from an item.
   * @returns {*|undefined}
   */
   ...
   * @param {number} rowPos Row range position.
   * @param {number} colPos Column range position.
   * @returns {number}
   */
   ...
   * @param {number} pos Range row position.
   * @returns {Row}
   */
   ...
   * @param {number} pos Range column position.
   * @returns {Column}
   */
