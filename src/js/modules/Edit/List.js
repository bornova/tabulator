...
export default class Edit {
   ...
   * @param {string} char Character to scroll to.
   */
  _scrollToValue(char) {
    clearTimeout(this.filterTimeout)
   ...
   * @param {string|HTMLElement|Function} contents Placeholder content or content factory.
   */
   ...
   * @param {Array<*>|object} inputValues Raw option values.
   ...
   * @param {Array<object>} data Target data array.
   ...
   * @param {object} option Group option definition.
   * @param {number} level Nesting level.
   * @returns {object}
   */
  ...
  /**
   * Sort list options.
   * @param {Array<object>} options Option list to sort.
   * @returns {Array<object>}
   */
   ...
   * @param {Function} sorter Sort comparator function.
   * @param {Array<object>} options Option list to sort.
   */
   ...
   * @param {Function} func Filter predicate.
