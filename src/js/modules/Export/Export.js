...
import columnLookups from './defaults/columnLookups'
import rowLookups from './defaults/rowLookups'
...
export default class Export extends Module {
  ...
  generateRowElement(row, setup, styles) {
    ...
    if (setup.rowFormatter && row.type === 'row' && this.config.formatCells !== false) {
      const formatComponent = Object.create(row.component)

      formatComponent.getElement = () => rowEl

      setup.rowFormatter(formatComponent)
    }
