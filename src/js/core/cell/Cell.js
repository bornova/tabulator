...
export default class Cell extends CoreFeature {
   ...
   */
  _generateContents() {
    const wrap = (val) => `<span class="tabulator-cell-content">${val}</span>`
    const val = this.chain('cell-format', this, null, () => (this.element.innerHTML = wrap(this.value)))
    ...
    switch (typeof val) {
      ...
      case 'undefined':
        ...
        break
      default:
        this.element.innerHTML = wrap(val)
    }
  }
