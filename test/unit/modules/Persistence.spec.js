...
describe('Persistence module', () => {
	...
	it('should warn if invalid reader/writer functions are provided', () => {
		...
		expect(consoleWarnSpy).toHaveBeenNthCalledWith(1, 'Persistence Read Error - invalid reader set', 'invalidReader')
		expect(consoleWarnSpy).toHaveBeenNthCalledWith(2, 'Persistence Write Error - invalid reader set', 'invalidWriter')
	})
	...
	it('should set column layout with setColumnLayout method', () => {
		...
		expect(persistence.mergeDefinition).toHaveBeenCalledWith(mockTable.options.columns, mockLayout, true)
