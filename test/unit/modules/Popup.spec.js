...
describe('Popup module', () => {
	...
	it('should load popup with function content', () => {
		...
		expect(popup.loadPopup).toHaveBeenCalledWith(mockEvent, mockComponent, 'Popup Content', undefined, undefined)
	})
	...
	it('should load popup with string content', () => {
		...
		expect(popup.loadPopup).toHaveBeenCalledWith(mockEvent, mockComponent, mockContent, undefined, undefined)
	})
	...
	it('should unwrap _group and _row components', () => {
		...
		expect(popup.loadPopup).toHaveBeenCalledWith(mockEvent, mockGroup._group, mockContent, undefined, undefined)

		// Load popup event for row
		popup.loadPopupEvent(mockContent, mockEvent, mockRow)

		// Verify loadPopup was called with unwrapped row
		expect(popup.loadPopup).toHaveBeenCalledWith(mockEvent, mockRow._row, mockContent, undefined, undefined)
	})
	...
	it('should create popup with string content', () => {
		...
		// Verify the loadPopup was called with the right params
		expect(Popup.prototype.loadPopup).toHaveBeenCalledWith(mockEvent, mockComponent, content, undefined, undefined)
	...
	it('should handle custom position when no event is provided', () => {
		...
		expect(Popup.prototype.loadPopup).toHaveBeenCalledWith(null, mockComponent, content, undefined, position)
