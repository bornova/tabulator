...
describe('Accessor', function () {
	...
	const tableColumns = [
		...
		},
		{
			title: 'Age',
			field: 'age',
			accessor: function (value, data, type) {
				return value + ' years'
			}
		},
		{
	...
	beforeAll(function () {
		...
		Accessor.accessors.test = function (value) {
			return value + '-test'
		}
	})
	...
	test('lookupAccessor returns function directly', function () {
		const customFunc = function (value) {
			return value
		}
	...
	test('transformRow applies accessors to data', function () {
		...
		const mockColumn = {
			...
			getFieldValue: function (data) {
				return data.age
			},
			setFieldValue: function (data, value) {
				data.age = value
			},
